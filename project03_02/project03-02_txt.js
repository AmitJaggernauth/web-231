...
const captions = [
  ...
  "Docking with a cargo spacecraft",
  "Crew inside the Destiny laboratory module",
  "Astronaut conducting a spacewalk",
  "Panoramic view of Earth from the cupola",
  "Sunset seen from the station",
  "Aurora australis beneath the ISS",
  "Crossing over the Sahara Desert",
  "Cloud formations over the Atlantic",
  "California coastline at daybreak",
  "Rotating solar arrays in sunlight",
  "Silhouette of the station against Earth",
  "Star field beyond the horizon",
  "Hubble servicing mission view"
];
